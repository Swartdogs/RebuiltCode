...
public final class Constants
{
    ...
    public static class ShooterConstants
    {
        ...
        public static final List<Integer>               BLUE_HUB_TAG_IDS     = List.of(2, 3, 4, 5);
        public static final List<Integer>               RED_HUB_TAG_IDS      = List.of(18, 19, 20, 21);
        public static final List<Integer>               ALL_HUB_TAG_IDS      = List.of(2, 3, 4, 5, 18, 19, 20, 21);
